...
module.exports.createProject = async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ status: "200", message: "Successfully created a post" });
};
...
module.exports.editProject = async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ status: "200", message: "Successfully edited a post" });
};
...
module.exports.deleteProject = async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ status: "200", message: "Successfully deleted a post" });
};
